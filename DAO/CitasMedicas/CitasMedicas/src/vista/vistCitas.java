...
public class vistCitas extends javax.swing.JFrame {
    String []columnas={"CODIGO","NOMBRES","APELLIDOS","GENERO","EDAD","FECHA","HORA","CLINICA"}; 
   ...
   //METODO PARA CARGAR EN JTABLE LAS CONSULTAS GUARDADAS
    ...
    {  tablaDatos.getTableHeader().setReorderingAllowed(false); //Para evitar que se puedan mover las columnas del JTable
        ...
        for (Citas fila : data)            
        {
            ...
            obj[7]=fila.getIdClinica().getIdClinica();  
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                                ...
                                .addGap(24, 24, 24)
                                .addComponent(txtClinica, javax.swing.GroupLayout.PREFERRED_SIZE, 79, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(24, 24, 24))
    ...
    private void tablaDatosMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tablaDatosMouseClicked
       ...
       this.txtClinica.setText(tablaDatos.getValueAt(tablaDatos.getSelectedRow(),7).toString());
